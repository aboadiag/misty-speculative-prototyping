...
## misty_multimodal_processing.py (mmp)
Performs vision processing (e.g. cropping, learning faces, etc) and speech request processing. Integrates Eleven Labs Client API Library and misty_vision_module.py. 

## misty_brain.py
Misty's decision-making and behavioral module. Imports helper functions from modules mvp and mmp (e.g. user_calibration).
