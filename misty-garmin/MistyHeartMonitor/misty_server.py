...
ELEVEN_API_KEY = "sk_1017f42d093410a0731f1b926f3e18965719d4e26357e514"     # <--- PASTE YOUR KEY HERE
VOICE_ID = "21m00Tcm4TlvDq8ikWAM"    # Rachel Voice ID

#misty config
MISTY_IP = "172.26.189.224"
...
def misty_startup_scan():
    ...
    try:
        ...
        requests.post(f"{base_url}/head", json={"Pitch": -5, "Roll": 0, "Yaw": 40, "Velocity": 60})
        ...
        print("   -> Panning head...")
        requests.post(f"{base_url}/head", json={"Pitch": -5, "Roll": 0, "Yaw": -40, "Velocity": 20}) # Slow sweep
